...
namespace Logistics.Common
{
    public class HttpHelper
    {
        ...
        public static string HttpPost(string posturl, string postData)
        {
            ...
            return HttpPost(posturl, postData, encoding);
        }
        /// <summary>
        /// POST请求
        /// </summary>
        ...
        /// <param name="postData">The post data.</param>
        /// <returns>System.String.</returns>
        public static string HttpPost(string posturl, string postData, Encoding encoding)
        {
            ...
            try
            {
                ...
                request.Method = "POST";
                request.Referer = "nongjitong CRM Application";
                //request.Headers.Add("User-Agent", "nongjitong CRM Application");
